...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.color = isDarkMode ? 'rgba(255, 255, 255, 0.5)' : 'rgba(30, 136, 229, 0.5)';
      }
  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      <canvas
        ref={canvasRef}
      ...
      <div className="container mx-auto px-6 pt-24 pb-16 z-10 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-aelityx-dark dark:text-white font-roboto leading-tight">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="outline" className="border-aelityx-blue text-aelityx-blue dark:text-aelityx-blue/80 hover:bg-aelityx-blue hover:text-white dark:hover:bg-aelityx-blue/80 dark:hover:text-white px-8 py-6 rounded-md text-lg">
                Descubre cómo
              </Button>
            </div>
          </div>
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#propuesta" className="bg-white dark:bg-gray-800 p-3 rounded-full shadow-md flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-aelityx-blue dark:text-aelityx-blue/80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
